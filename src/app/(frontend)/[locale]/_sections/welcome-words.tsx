...
async function WelcomingWord({ locale }: { locale: string }) {
  ...
  return (
    <section className="py-8 px-4">
      <div className="flex flex-col md:flex-row-reverse justify-between items-end w-full gap-8 max-w-7xl mx-auto overflow-hidden rounded-lg">
        {/* Right side - Image */}
        <div className="overflow-hidden w-full md:w-1/2 h-64 md:h-auto hidden md:block animate-bounce-slow-infinite">
          <Image
            src="/profile-pak-sony-2.svg"
            alt=""
            width={540}
            height={540}
        ...
        <div className="w-full p-8 flex flex-col justify-between">
          <div className='gap-4 flex flex-col'>
            ...
            <div className="text-primary overflow-hidden flex justify-end">
